                        ...
                        <div class="panel sesi-tanggal">
                            @foreach($tanggalSeminar['sesi'] as $key => $sesi)
                                @if(isset($ketersediaanDosen[$tanggalSeminar['tanggal']][$key]) && $ketersediaanDosen[$tanggalSeminar['tanggal']][$key] == 1)
                                    <button class="btn btn-default btn-xs btn-block sesi sesi-success" value="{{$sesi}}"><p>sesi {{$key}}</p></button>
                                @else
                                    <button class="btn btn-default btn-xs btn-block sesi" value="{{$sesi}}"><p>sesi {{$key}}</p></button>
                                @endif
                            @endforeach
                        </div>   
                    </div>
