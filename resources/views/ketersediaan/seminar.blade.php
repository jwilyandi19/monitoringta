...
@section('content')
    ...
    <div class="panel" style="margin-left: auto; margin-right: auto; padding : 30px;">
        <div class="judul-halaman">
            <h4><strong>Ketersediaan Seminar Dosen</strong></h4>
            <hr>
        </div>
        <div class="pencarian">
            <table id = "ketersediaanseminar" class="table table-striped table-hover" cellspacing="0" width="100%">
                <thead>
                    <tr class="success">
                        <th rowspan="3" style="vertical-align: middle; white-space: nowrap;">No</th>
                        <th rowspan="3" style="vertical-align: middle; white-space: nowrap;">Dosen Penguji</th>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        @foreach($jadwals as $jadwal)
                            @if($ketersediaanDosen[$dosen->id_dosen][$jadwal->id_js])
